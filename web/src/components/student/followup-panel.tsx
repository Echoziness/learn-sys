    ...
    <Card>
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between gap-2">
          <CardTitle className="text-sm">提问 / 追问</CardTitle>
          <Badge variant="outline" className="text-[10px]">澄清工具 · 不计掌握度</Badge>
        </div>
      </CardHeader>
        ...
        {state.kind === "graded" && (
          <>
            <div className="flex items-center gap-2">
              <Badge
                variant="secondary"
                className={state.isCorrect ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}
              >
